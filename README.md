...
Extract individual chapters from a YouTube video as separate MP3 files with ID3 metadata (title, artist, album).
...
- **YouTube MP3 Extraction** - Enter a YouTube URL, select chapters, edit metadata, and download as MP3 files (saved to `./output/`).
